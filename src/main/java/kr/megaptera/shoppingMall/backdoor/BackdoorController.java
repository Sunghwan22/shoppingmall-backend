...
public class BackdoorController {
    ...
    public String setupProduct() {
        ...
        jdbcTemplate.update("" +
                ...
                "product_number, stock, updated_at, views)" +
                " VALUES(2, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)",
            "전자기기", now, 1000L, 2500L, "상세설명입니다", "애플", 5L, 20000L, "애플워치8", 1L,
            5000L, now, 1500);
        ...
        for (long i = 0; i < 6; i += 1) {
            jdbcTemplate.update("" +
                    ...
                    "product_number, stock, updated_at, views)" +
                    " VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)",
                i + 3, "전자기기", now, 1000L, 2500L, "상세설명입니다", "애플", 5L, 20000L, "애플워치" + i + 9, 1L,
                5000L, now, 1500);
        }
        ...
        jdbcTemplate.update("" +
                ...
                "product_id, is_thumbnail_image, url)" +
                "VALUES(?, ?, ?)",
            2L, "true", "https://test-s3-image.s3.ap-northeast-2.amazonaws.com/%E1%" +
                "84%8B%E1%85%A2%E1%84%91%E1%85%B3%E1%86%AF%E1%84%8B%E1%85%AF%E1%84%8E%E1%85%B5.jpeg");
        ...
        jdbcTemplate.update("" +
                ...
                "product_id, is_thumbnail_image, url)" +
                "VALUES(?, ?, ?)",
            2L, "false", "https://test-s3-image.s3.ap-northeast-2.amazonaws.com/%E" +
                "1%84%8B%E1%85%A2%E1%84%91%E1%85%B3%E1%86%AF%E1%84%8B%E1%85%AF%E1%84%8E%E1%85%B52.jpeg");
